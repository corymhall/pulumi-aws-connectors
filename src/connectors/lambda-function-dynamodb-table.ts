...
export interface LambdaFunctionToDynamoDBTableConnectorArgs {
  /**
   * The source resource.
   */
 ...
 */
export class LambdaFunctionToDynamoDBTableConnector extends pulumi.ComponentResource {
  constructor(name: string, args: LambdaFunctionToDynamoDBTableConnectorArgs, opts?: pulumi.ComponentResourceOptions) {
    super('aws-connectors:index:LambdaFunctionToDynamoDBTableConnector', name, args, opts);
