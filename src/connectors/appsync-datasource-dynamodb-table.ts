...
export interface AppSyncDataSourceToDynamoDBTableConnectorArgs {
  /**
   * The source resource.
   */
...
/**
 * Connect a AppSync DataSource to a DynamoDB Table.
 */
export class AppSyncDataSourceToDynamoDBTableConnector extends pulumi.ComponentResource {
  constructor(name: string, args: AppSyncDataSourceToDynamoDBTableConnectorArgs, opts?: pulumi.ComponentResourceOptions) {
    super('aws-connectors:index:AppSyncDataSourceToDynamoDBTableConnector', name, args, opts);
