...
export interface SfnStateMachineToS3BucketConnectorArgs {
  /**
   * The source resource.
   */
 ...
 */
export class SfnStateMachineToS3BucketConnector extends pulumi.ComponentResource {
  constructor(name: string, args: SfnStateMachineToS3BucketConnectorArgs, opts?: pulumi.ComponentResourceOptions) {
    super('aws-connectors:index:SfnStateMachineToS3BucketConnector', name, args, opts);
