 ...
 */
export class AppSyncDataSourceToDynamoDBTable extends pulumi.ComponentResource {
  constructor(name: string, args: AppSyncDataSourceToDynamoDBTableArgs, opts?: pulumi.ComponentResourceOptions) {
    super('aws-connectors:index:AppSyncDataSourceToDynamoDBTable', name, args, opts);
