...
export interface SfnStateMachineToS3BucketArgs {
  /**
   * The source resource.
   */
...
/**
 * Connect a StepFunctions StateMachine to a S3 Bucket.
 */
export class SfnStateMachineToS3Bucket extends pulumi.ComponentResource {
  constructor(name: string, args: SfnStateMachineToS3BucketArgs, opts?: pulumi.ComponentResourceOptions) {
    super('aws-connectors:index:SfnStateMachineToS3Bucket', name, args, opts);
