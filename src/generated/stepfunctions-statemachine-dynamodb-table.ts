...
export interface SfnStateMachineToDynamoDBTableArgs {
  /**
   * The source resource.
   */
 ...
 */
export class SfnStateMachineToDynamoDBTable extends pulumi.ComponentResource {
  constructor(name: string, args: SfnStateMachineToDynamoDBTableArgs, opts?: pulumi.ComponentResourceOptions) {
    super('aws-connectors:index:SfnStateMachineToDynamoDBTable', name, args, opts);
